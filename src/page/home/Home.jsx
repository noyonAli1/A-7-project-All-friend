    ...
    <div className=" ">
      <div >
        ...
        <div className="container w-[77%] mx-auto grid grid-cols-1  md:grid-cols-4 gap-6">
          ...
          <div className=" card card-dash bg-base-100 border border-gray-400 shadow-md hover:bg-blue-50">
          ...
          <div className="card card-dash bg-base-100 border hover:bg-blue-50 border-gray-400 shadow-md">
            <div className="card-body items-center lg:py-10 py-6">
